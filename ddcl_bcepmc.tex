...
Cross centre gauge is the distance between immediate columns of bolts on either side of beam web.
	...
	\subsection{Extended both ways}
		\qquad \qquad [Reference: SCI - Steel Designers Manual, page 733, 6th Edition (2003)]
		\begin{equation}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{COLCP2.png}
\end{figure}
...
In the following section, checks are done considering fillet weld.\\
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{Stiffeners.png}
	%\caption{}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.575]{weld_details2.png}
	%\caption{}
	%\label{fig:EPstiffener}
\end{figure}
