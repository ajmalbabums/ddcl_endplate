...
%------------------------------------------------------
\begin{comment}
Linear stress distribution is assumed.
 Number of bolts in the configuration \\

	\begin{equation}
		N \ge \sqrt{\frac{6 M n}{p T_{db}}}
	\end{equation}
	
Where, \\

\indent $n$ = Number of vertical columns in the connection \\
\indent $V_{db}$ = Design strength of the bolt \\
 
 For wide beams, with maximum allowe plate width,
\begin{equation}
maximum plate width \ge 2(minumum end distace + minimum pitch + 50 mm) + beam web thickness
\end{equation}
  $n$ is taken as 4 
